    ...
    return {
      experience: {
        ...
        descriptions: [
          ...
          "Initiated and implemented a cutting edge cloud computing solution for managing constructions projects which drastically improved communication and productivity."
        ]
      }
    };
  }
